...
public class VentanaEliminar extends javax.swing.JFrame {
    ...
    public VentanaEliminar(ConexionDB4O c) {
        this.c = c;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jRadioButton2.setText("Rebotes");

        jRadioButton3.setText("Asistencias");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String op;
        op = jTextField1.getText();
        try{
            c.conectar();
         if(op.isEmpty()){
            JOptionPane.showMessageDialog(this, "Debe rellenar el campos");
         }} catch (DB4OException ex) {
             JOptionPane.showMessageDialog(this,"Has introducido un valor no valido");
         }
